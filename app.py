...
def display_color_palette(hex_colors, rgb_colors):
    ...
    for hex_color, rgb_color in zip(hex_colors, rgb_colors):
        ...
        <div style="text-align: center; margin: 20px; width: 200px; font-family: Arial, sans-serif;">
            <div style="display: inline-block; width: 140px; height: 140px; background-color: {hex_color}; border-radius: 20px; border: 4px solid #ffffff; box-shadow: 0px 8px 16px rgba(0, 0, 0, 0.2); overflow: hidden;">
            </div>
